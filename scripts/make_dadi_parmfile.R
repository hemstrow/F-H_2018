...
for(i in 1:length(ip)){
  if(mods[i] == "cgrowth"){
    ...
    tip <- paste0(c(nu1B[1], nu2B[1], K2[1], K3[1], ts[1], tp[1], m12[1], m21[1], r2[1], r3[1]), collapse = ",")
    tlb <- paste0(c(nu1B[2], nu2B[2], K2[2], K3[2], ts[2], tp[2], m12[2], m21[2], r2[2], r3[2]), collapse = ",")
    tub <- paste0(c(nu1B[3], nu2B[3], K2[3], K3[3], ts[3], tp[3], m12[3], m21[3], r2[3], r3[3]), collapse = ",")
  }
  else if (mods[i] == "lgrowth_p2"){
    tip <- paste0(c(nu1B[1], nu2B[1], K2[1], nu2f[1], ts[1], tp[1], m12[1], m21[1], r2[1]), collapse = ",")
    tlb <- paste0(c(nu1B[2], nu2B[2], K2[2], nu2f[2], ts[2], tp[2], m12[2], m21[2], r2[2]), collapse = ",")
    tub <- paste0(c(nu1B[3], nu2B[3], K2[3], nu2f[3], ts[3], tp[3], m12[3], m21[3], r2[3]), collapse = ",")
  }
  else if (mods[i] == "lgrowth_p3"){
    tip <- paste0(c(nu1B[1], nu2B[1], nu1f[1], K3[1], ts[1], tp[1], m12[1], m21[1], r3[1]), collapse = ",")
    tlb <- paste0(c(nu1B[2], nu2B[2], nu1f[2], K3[2], ts[2], tp[2], m12[2], m21[2], r3[2]), collapse = ",")
    tub <- paste0(c(nu1B[3], nu2B[3], nu1f[3], K3[3], ts[3], tp[3], m12[3], m21[3], r3[3]), collapse = ",")
  }
  ip[i] <- paste0("[", tip, "]")
  lb[i] <- paste0("[", tlb, "]")
  ub[i] <- paste0("[", tub, "]")
